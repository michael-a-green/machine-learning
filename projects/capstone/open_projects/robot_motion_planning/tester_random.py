...
if __name__ == '__main__':
    ...
    for run in range(2):
        ...
        while run_active:
            ...
            if robot_pos['location'] != testrobot.location:
                print "ERROR: Robot predicted location %0s but robot location is actually %0s"%(testrobot.location,robot_pos['location'] )
